...
class LabDataRepository:
    ...
    def ensure_schema(self) -> None:
        try:
            self.connection.execute("CREATE SCHEMA IF NOT EXISTS lab")
        ...
        self._ensure_id_defaults()

        for project_name, result_unit in DEFAULT_TEST_PROJECTS:
            self.connection.execute(
                """
                INSERT INTO lab.test_projects (project_name, result_unit)
                VALUES (%s, %s)
    ...
    def _ensure_id_defaults(self) -> None:
        self.connection.execute(
            """
            DO $$
            BEGIN
