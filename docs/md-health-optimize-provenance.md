...
| `9d2a221` | Runtime probes are bounded and child cancellation terminates the owned process group. | `runtime_probe.py`, `process_control.py`, `runner.py`, `run_host_worker.sh`, and the corresponding Worker tests. |
