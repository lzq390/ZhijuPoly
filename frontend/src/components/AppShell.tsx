  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#f4f6f8] text-slate-950">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className={isHome ? "min-h-0 flex-1 overflow-hidden" : "flex-1 overflow-y-auto px-4 py-5 md:px-8 md:py-8"}>
          <div className={isHome ? "h-full" : ["relative mx-auto flex flex-col gap-8", fullBleed ? "max-w-none" : "max-w-[1480px]"].join(" ")}>
            {children}
          </div>
        </main>
      </div>
