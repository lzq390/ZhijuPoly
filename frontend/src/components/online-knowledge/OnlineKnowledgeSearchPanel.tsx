...
import { exportOnlineKnowledgeCsv } from "../../services/api";
import type {
...
export function OnlineKnowledgeSearchPanel() {
    ...
    <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
      <div className="space-y-4">
        <form onSubmit={handleSubmit} autoComplete="off" className="rounded-[32px] border border-white/70 bg-white/75 p-4 shadow-soft md:p-5">
          ...
          <div className="mt-3 grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_220px]">
            <Field label="API Key">
              <Input
                type="password"
                value={apiKey}
